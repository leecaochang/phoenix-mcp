...
[English](README.md) | [Español](README.es.md) | [Français](README.fr.md) | **Deutsch** | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-Hant.md) | [日本語](README.ja.md) | [한국어](README.ko.md)
...
Das Bedienfeld unterstützt derzeit Englisch, Spanisch, Französisch, Deutsch, vereinfachtes Chinesisch, traditionelles Chinesisch, Koreanisch und Japanisch. Um die Sprache des Bedienfelds manuell zu ändern, öffnen Sie **Phoenix MCP > Einstellungen > Sprache** und wählen Sie eine Sprache aus. Wählen Sie **Auto**, um wieder der Sprache Ihres Home Assistant-Profils zu folgen.
