...
[English](README.md) | [Español](README.es.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [Nederlands](README.nl.md) | **简体中文** | [繁體中文](README.zh-Hant.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [Русский](README.ru.md)
...
面板目前支持英语、西班牙语、法语、德语、荷兰语、俄语、简体中文、繁体中文、韩语和日语。如需手动更改面板语言，请打开 **Phoenix MCP > 设置 > 语言** 并选择一种语言。选择 **自动** 即可恢复跟随 Home Assistant 个人资料语言。
