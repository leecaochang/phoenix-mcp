...
from custom_components.phoenix_mcp.mesa_core.conflict import ConflictResolver, FieldExplanation, Layer
...
if TYPE_CHECKING:
    from custom_components.phoenix_mcp.mesa_core.store import DeploymentDefaults, ProfileStore
