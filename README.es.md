...
[English](README.md) | **Español** | [Français](README.fr.md) | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-Hant.md) | [日本語](README.ja.md) | [한국어](README.ko.md)
...
El panel admite actualmente inglés, español, francés, chino simplificado, chino tradicional, coreano y japonés. Para cambiar el idioma manualmente, abra **Phoenix MCP > Configuración > Idioma** y elija un idioma. Seleccione **Automático** para volver a seguir el idioma del perfil de Home Assistant.
