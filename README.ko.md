...
[English](README.md) | [Español](README.es.md) | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-Hant.md) | [日本語](README.ja.md) | **한국어**
...
패널 언어를 수동으로 변경하려면 **Phoenix MCP > 설정 > 언어**를 열고 언어를 선택하세요. **자동**을 선택하면 다시 Home Assistant 프로필 언어를 따릅니다.
