...
**English** | [Español](README.es.md) | [Français](README.fr.md) | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-Hant.md) | [日本語](README.ja.md) | [한국어](README.ko.md)
...
The panel currently supports English, Spanish, French, Simplified Chinese, Traditional Chinese, Korean, and Japanese. To change the panel language manually, open **Phoenix MCP > Settings > Language** and choose a language. Choose **Auto** to follow your Home Assistant profile language again.
