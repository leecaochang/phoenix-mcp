/* Phoenix MCP documentation chrome and behavior. */
(function () {
  "use strict";
  ...
  var REPO = "https://github.com/leecaochang/phoenix-mcp";
  ...
  function buildHeader() {
    ...
    if (!h) return;
    var mark =
      '<img class="mark" src="assets/phoenix-logo.png" alt="" width="30" height="30" />';
    h.innerHTML =
      ...
      '<a class="brand" href="' + rel("index.html") + '">' + mark +
        '<span class="brand-text"><span>Phoenix MCP</span></span>' +
      '</a>' +
  ...
  function buildFooter() {
    ...
    f.innerHTML =
      '<div class="footer-inner">' +
        '<p>Phoenix MCP &middot; scoped, audited, revocable access to Home Assistant for AI agents.</p>' +
