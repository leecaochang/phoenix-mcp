...
[English](README.md) | [Español](README.es.md) | **Français** | [Deutsch](README.de.md) | [Nederlands](README.nl.md) | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-Hant.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [Русский](README.ru.md)
...
Le panneau prend actuellement en charge l'anglais, l'espagnol, le français, l'allemand, le néerlandais, le russe, le chinois simplifié, le chinois traditionnel, le coréen et le japonais. Pour changer manuellement la langue du panneau, ouvrez **Phoenix MCP > Paramètres > Langue** et choisissez une langue. Choisissez **Auto** pour suivre à nouveau la langue de votre profil Home Assistant.
